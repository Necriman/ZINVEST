...
import { 
  TrendingUp, ArrowLeft, BookOpen, Clock, Play, 
...
export default function InvestingBasicsPage() {
  ...
  const LESSONS = [
    ...
    { id: 9, title: t.trackPage.creditScores, completed: false, unlocked: false },
    { id: 10, title: t.trackPage.bankingBasics, completed: false, unlocked: false },
  ];
              ...
              <div className="glass-card rounded-2xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <Link
                      href={`/turbo-ai?course=investing-basics&lesson=${selectedLesson.id}`}
                    >
