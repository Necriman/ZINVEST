...
import { 
  Wallet, ArrowLeft, BookOpen, Clock, Play, 
...
export default function PersonalFinancePage() {
  ...
  const LESSONS = [
    { id: 1, title: t.trackPage.financialMindset, completed: true, unlocked: true },
    { id: 2, title: t.trackPage.financialGoals, completed: true, unlocked: true },
    { id: 3, title: t.trackPage.buildingBudget, completed: false, unlocked: true, current: true },
    { id: 4, title: t.trackPage.emergencyFunds, completed: false, unlocked: true },
    { id: 5, title: t.trackPage.whatIsMoney, completed: false, unlocked: true },
    { id: 6, title: t.trackPage.understandingCashFlow, completed: false, unlocked: false },
    { id: 7, title: t.trackPage.revenueVsProfit, completed: false, unlocked: false },
    ...
    { id: 11, title: t.trackPage.assetsAndLiabilities, completed: false, unlocked: false },
    { id: 12, title: t.trackPage.financialStatements101, completed: false, unlocked: false },
    { id: 13, title: t.trackPage.financialGoals, completed: false, unlocked: false },
    { id: 14, title: t.trackPage.financialMindset, completed: false, unlocked: false },
  ];
