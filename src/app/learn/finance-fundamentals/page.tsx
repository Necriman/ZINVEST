...
import { 
  DollarSign, ArrowLeft, BookOpen, Clock, Users, Play, 
...
export default function FinanceFundamentalsPage() {
  ...
  const LESSONS = [
    ...
    { id: 2, title: t.trackPage.understandingCashFlow, duration: "10 min", completed: true, unlocked: true },
    { id: 3, title: t.trackPage.revenueVsProfit, duration: "12 min", completed: false, unlocked: true, current: true },
    { id: 4, title: t.trackPage.financialStatements101, duration: "15 min", completed: false, unlocked: true },
    { id: 5, title: t.trackPage.assetsAndLiabilities, duration: "10 min", completed: false, unlocked: true },
    { id: 6, title: t.trackPage.buildingBudget, duration: "12 min", completed: false, unlocked: false },
    { id: 7, title: t.trackPage.emergencyFunds, duration: "8 min", completed: false, unlocked: false },
    { id: 8, title: t.trackPage.debtManagement, duration: "14 min", completed: false, unlocked: false },
    { id: 9, title: t.trackPage.creditScores, duration: "10 min", completed: false, unlocked: false },
    { id: 10, title: t.trackPage.bankingBasics, duration: "8 min", completed: false, unlocked: false },
    { id: 11, title: t.trackPage.financialGoals, duration: "12 min", completed: false, unlocked: false },
    { id: 12, title: t.trackPage.financialMindset, duration: "15 min", completed: false, unlocked: false },
  ];
    ...
    <main className="min-h-screen bg-[#0a0f1c]">
      ...
      <section className="relative px-6 pt-32 pb-24">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 -left-32 h-[400px] w-[400px] rounded-full bg-emerald-500/10 blur-[100px]"></div>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white md:text-4xl">{t.trackPage.financeFundamentals}</h1>
                <p className="text-slate-400 mt-1">{t.trackPage.financeFundamentalsDesc}</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-400 mt-6">
              <div className="flex items-center gap-2">
                ...
                12 {t.trackPage.lessonsCount}
              </div>
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4" />
                2 {t.trackPage.hoursTotal}
              </div>
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4" />
                2,340 {t.trackPage.students}
              </div>
            </div>
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between text-sm mb-2">
                ...
                <span className="text-emerald-400 font-medium">{completedCount}/{LESSONS.length} {t.trackPage.completed}</span>
              </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`text-sm font-medium truncate ${
                          lesson.unlocked ? "text-white" : "text-slate-500"
                        }`}>
                          {lesson.title}
                        </p>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">
                      After passing the test, Global Top winners get Premium for 3/2/1 days.
                    </p>
                  </div>
                  <Link
