            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="lg:col-span-2">
              <div className="glass-card rounded-2xl overflow-hidden">
                <div className="relative aspect-video bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                  ...
                  <div
                    className="group relative flex h-20 w-20 cursor-pointer items-center justify-center rounded-full bg-purple-500/10 transition-all hover:scale-110 hover:bg-purple-500/20"
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <button
                      onClick={() => openPdfForLessonId(selectedLesson.id)}
                      className="flex items-center gap-2 rounded-full bg-purple-500 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-purple-600 active:scale-95"
                    >
