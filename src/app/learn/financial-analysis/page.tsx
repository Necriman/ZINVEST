...
import { 
  BarChart3, ArrowLeft, BookOpen, Clock, Play, 
...
export default function FinancialAnalysisPage() {
  ...
  const LESSONS = [
    { id: 1, title: t.trackPage.whatIsMoney, completed: true, unlocked: true },
    { id: 2, title: t.trackPage.understandingCashFlow, completed: false, unlocked: true, current: true },
    { id: 3, title: t.trackPage.revenueVsProfit, completed: false, unlocked: true },
    { id: 4, title: t.trackPage.financialStatements101, completed: false, unlocked: true },
    { id: 5, title: t.trackPage.assetsAndLiabilities, completed: false, unlocked: false },
    { id: 6, title: t.trackPage.buildingBudget, completed: false, unlocked: false },
    { id: 7, title: t.trackPage.emergencyFunds, completed: false, unlocked: false },
    { id: 8, title: t.trackPage.debtManagement, completed: false, unlocked: false },
  ];
                  ...
                  {LESSONS.map((lesson, idx) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500">{t.trackPage.lessonSoon}</p>
                      </div>
              ...
              <div className="glass-card rounded-2xl overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs text-slate-500 mb-3">
                    ...
                    <span>•</span>
                    <span>{t.trackPage.lessonSoon}</span>
                  </div>
