...
const TargetAudience = () => {
  ...
  return (
    <section id="who-its-for" ref={ref} className="relative bg-white dark:bg-[#0a0f1c] px-4 py-16 sm:px-6 sm:py-24">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {audiences.map((audience, index) => (
            <motion.div 
              ...
              className="group glass-card flex flex-col items-center text-center rounded-2xl p-8 transition-all duration-300 hover:border-blue-500/30 hover:bg-white dark:bg-[#0a0f1c]/[0.08] hover:scale-[1.02]"
            >
