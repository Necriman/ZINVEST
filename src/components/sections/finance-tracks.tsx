...
export default function FinanceTracks() {
  ...
  return (
    <section id="finance-tracks" ref={ref} className="relative px-6 py-24 bg-[#0a0f1c]">
          ...
          {TRACKS.map((track, idx) => (
            ...
            >
              <Link href={track.href}>
                <div 
                  className="glass-card flex flex-col rounded-3xl p-8 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.07] group cursor-pointer h-full hover:scale-[1.02]"
                >
