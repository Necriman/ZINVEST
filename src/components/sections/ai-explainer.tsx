...
export default function AIExplainer() {
  ...
  return (
    <section ref={ref} className="relative px-6 py-24 bg-white dark:bg-[#0a0f1c]">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="glass-card overflow-hidden rounded-[2rem] border border-white/10 bg-white dark:bg-[#0a0f1c]/5 backdrop-blur-sm">
              ...
              <div className="relative flex flex-col rounded-3xl border border-white/10 bg-[#0d1117] shadow-2xl">
                ...
                <div className="flex flex-col space-y-6 p-6">
                  ...
                  <div className="flex justify-start">
                    <div className="max-w-[90%] space-y-3 rounded-2xl rounded-tl-none bg-white dark:bg-[#0a0f1c]/5 border border-white/10 px-5 py-4 text-sm leading-relaxed text-slate-300">
                ...
                <div className="p-4 pt-0">
                  <div className="relative flex items-center">
                    <input 
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-white dark:bg-[#0a0f1c]/5 py-3 pl-4 pr-12 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                      disabled
                    />
