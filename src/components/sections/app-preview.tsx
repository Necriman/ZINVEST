...
import { slideUpVariants, staggerContainer, viewportOnce, useReducedMotion } from '@/lib/motion';
...
const AppPreview = () => {
  ...
  return (
    <section id="app-preview" className="relative bg-[var(--bg-card)] px-4 py-16 sm:px-6 sm:py-24">
            ...
            >
              ...
              >
                {features.map((item, index) => (
                  <motion.li 
                    key={index}
                    variants={slideUpVariants(0, 0.4)}
              ...
              >
                <Link href="/modules" className="btn-interactive w-full sm:w-auto">
                  <span className="btn-glow inline-flex min-h-12 w-full items-center justify-center rounded-full bg-[#3b82f6] px-6 py-3 text-[15px] font-medium text-white transition-colors duration-200 hover:bg-[#2563eb] sm:w-auto sm:px-8 sm:text-[16px]">
                    {t.appPreview.downloadApp}
                  </span>
                </Link>
                <Link href="/learn" className="btn-interactive w-full sm:w-auto">
                  <span className="inline-flex min-h-12 w-full items-center justify-center rounded-full border border-[var(--border)] bg-[var(--bg-primary)] px-6 py-3 text-[15px] font-medium text-[var(--text-primary)] transition-colors duration-200 hover:bg-[var(--bg-secondary)] sm:w-auto sm:px-8 sm:text-[16px]">
            ...
            >
              <div className="relative">
                ...
                <div className="relative h-[500px] w-[250px] overflow-hidden rounded-[2.5rem] border-[6px] border-[#1e293b] bg-[#0d1117] shadow-2xl">
                  ...
                  <div className="h-full w-full overflow-hidden bg-[var(--bg-card)] pt-8 px-4">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-secondary)] p-3">
                        ...
                        <div className="mt-3 h-1.5 w-full overflow-hidden rounded-full bg-[var(--bg-card)]/10">
